...
use qubit_config::source::PropertiesConfigSourceBuilder;
...
#[test]
fn properties_builder_default_loads_configured_content() {
    let builder_default: fn() -> PropertiesConfigSourceBuilder = Default::default;
